(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("soundcycle", [], factory);
	else if(typeof exports === 'object')
		exports["soundcycle"] = factory();
	else
		root["soundcycle"] = factory();
})(this, function() {
  ...
  (0, _createClass3.default)(SoundCycle, [{
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
        ...
        var newTrackId, _ret, audioObj, audioChnl, looper, audioBuffer;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.t0 = this.currentMode;
                _context2.next = _context2.t0 === this.MODES.NEW_LANE ? 4 : _context2.t0 === this.MODES.SINGLE_SEQUENCE ? 8 : _context2.t0 === this.MODES.ADD_TO_LANE ? 15 : 23;
                break;

              case 4:
                return _context2.delegateYield(_regenerator2.default.mark(function _callee() {
                  var looper, audioBuffer, newLooperId;
                  return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          // Add new looper
                          looper = new _audiolooper2.default(_this.audioCtx);
                          _context.next = 3;
                          return _this.recorder.stopRecording({ type: 'buffer' });
                        ...
                        case 3:
                          ...
                          looper.addTrack({ id: newTrackId, audioBuffer: audioBuffer, trackAdded: function trackAdded(bufferSourceNode) {
              ...
              case 10:
                audioObj = _context2.sent;
                audioChnl = new AudioChl(this.audioCtx, audioObj);
              ...
              case 17:
                looper = this.loopers.get(this.currentLane);
                _context2.next = 20;
    ...
    key: 'enableEffect',
    value: function enableEffect(_ref4) {
      var chnlId = _ref4.chnlId,
          effectName = _ref4.effectName;
    ...
    key: 'disableEffect',
    value: function disableEffect(_ref5) {
    ...
    key: 'setEffectValue',
    value: function setEffectValue(_ref6) {
    ...
    value: function getChnlById(id) {
      ...
      if (id === this.masterChnlId) return this.wmstr;else if (id === this.recorderChnlId) return this.recorder;else {
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		...
		define("audiobufferchnl", [], factory);
	else if(typeof exports === 'object')
		exports["audiobufferchnl"] = factory();
	else
		root["audiobufferchnl"] = factory();
})(this, function() {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
/******/ 	var installedModules = {};
...
var _webaudioChnl = __webpack_require__(42);
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		...
		define("audiochnl", [], factory);
	else if(typeof exports === 'object')
		exports["audiochnl"] = factory();
	else
		root["audiochnl"] = factory();
})(this, function() {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
/******/ 	var installedModules = {};
...
var AudioChnl = function (_Chnl) {
  ...
  function AudioChnl(audioCtx, audioObj) {
    ...
    _this.audioObj.addEventListener('loadedmetadata', function (e) {
      _this.isReady = true;
      loaded();
    });
...
var v1 = __webpack_require__(110);
var v4 = __webpack_require__(111);
...
var _soundcycle = __webpack_require__(49);
